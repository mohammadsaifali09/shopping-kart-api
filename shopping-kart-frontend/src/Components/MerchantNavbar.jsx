...
const MerchantNavbar = () => {
  ...
  return (
    <div>
        <div className="nav">
            <div className="logo">
                <Link to=""><h3>Shopping Kart</h3></Link>
            </div>
            <div className="options">
                <div className="wishlist">
                    <Link to="/merchanthome/viewproductmerchant"><h4>Product</h4></Link>
                    <Link to="additem"><h4>Add Item</h4></Link>
                </div>
            </div>    
            ...
            <div onClick={()=>{setSub(!sub)}} className="profile">
                ...
                {sub && <div className="list">
                    ...
                    <Link to="" className="li" id='li2'>Check Order</Link>
                    <Link to="updatemerchant" className="li" id='li3'>Update Address</Link>
